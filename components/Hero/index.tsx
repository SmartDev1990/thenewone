        ...
        >
          ...
          <SwiperSlide>
            <div className="slider_item_container">
              ...
              <div className="title">Get minting discounts for holding Rice</div>
              <div className="content">
                You get some discount to mint NFTs or collections if you hold a certain amount of the Rice token.
              </div>
            </div>
          </SwiperSlide>
        </Swiper>
